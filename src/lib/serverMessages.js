...
export const SERVER_MESSAGES = [
  ...
  msg`That item is being voted on right now.`,
  msg`Items must be provided as a list.`,
  msg`Jira could not be reached. Try again shortly.`,
  ...
  msg`That item was not found.`,
  msg`That Jira site is not supported.`,
  ...
  msg`Your Jira connection expired. Connect again.`,
